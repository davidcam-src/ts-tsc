...
const mockBambooDirectory = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_bamboo_directory.json'), 'utf8'));
const mockBambooDirectoryUppercase = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_bamboo_directory_uppercase.json'), 'utf8'));
const mockDatalakeEmployees = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_datalake_employees.json'), 'utf8'));
const mockDatalakeSkills = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_datalake_skills.json'), 'utf8'));
const mockBambooCustomReport = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_bamboo_custom_report.json'), 'utf8'));
const mockBambooPtoList = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_bamboo_pto_list.json'), 'utf8'));
const expectedOutput = JSON.parse(fs.readFileSync(path.join(dataPath, 'expected_output.json'), 'utf8'));
const mockListBambooEmployees = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_list_bamboo_employees.json'), 'utf8'));
const mockListDatalakeEmployees = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_list_datalake_employees.json'), 'utf8'));
const mockListWithSkills = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_list_with_skills.json'), 'utf8'));
const mockListWithCustomBambooReport = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_list_custom_bamboo_report.json'), 'utf8'));
const mockListWithPto = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_list_with_pto.json'), 'utf8'));
const mockListWithSupervisorDisplayName = JSON.parse(fs.readFileSync(path.join(dataPath, 'mock_list_with_supervisor_display_name.json'), 'utf8'));
